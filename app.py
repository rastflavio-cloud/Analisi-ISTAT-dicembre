...
with tab1:
    ...
    with c2:
        ...
        ax_p1.set_title("ripartizione delle variazioni occupati e inattivi", fontweight='bold')
        st.pyplot(fig_p1)
...
with tab2:
    ...
    with c4:
        ...
        ax_p2.pie([abs(d['inc_occ_t']), abs(d['inc_ina_t'])], labels=labels_t, 
                  colors=['#3498db', '#95a5a6'], startangle=90, autopct='%1.1f%%', textprops={'fontweight':'bold'})
        ax_p2.set_title("ripartizione delle variazioni occupati e inattivi", fontweight='bold')
        st.pyplot(fig_p2)
